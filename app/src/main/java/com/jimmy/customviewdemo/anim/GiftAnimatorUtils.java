package com.jimmy.customviewdemo.anim;
...
/**
 * Created by jinguochong on 16-11-11.
 */
public class GiftAnimatorUtils {

    public static void flipChange(final View view, final View view1) {
    ...
    public static void cardChange(View view, Activity activity) {
    ...
    private static ObjectAnimator bgChange(final Activity activity) {
