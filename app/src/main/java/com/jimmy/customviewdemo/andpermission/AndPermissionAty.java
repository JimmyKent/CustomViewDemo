package com.jimmy.customviewdemo.andpermission;
...
public class AndPermissionAty extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_a_permission_toast).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_many_permission_toast:
                //AndPermission.with(aty or fragment).requestCode(100).permission(string...).send();
                break;
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        KLog.e("jimmy","ScreenSwitchAty onRequestPermissionsResult");
