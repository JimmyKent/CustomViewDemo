...
import com.jimmy.log.klog.BaseLog;
import com.jimmy.log.klog.FileLog;
import com.jimmy.log.klog.JsonLog;
import com.jimmy.log.klog.XmlLog;
...
public class KLog {
    ...
    private static String[] wrapperContent(String tagStr, Object... objects) {
        ...
        String className = targetElement.getClassName();//得到当前运行的类的名字
        ...
        String methodName = targetElement.getMethodName();//得到当前运行的方法名字
        int lineNumber = targetElement.getLineNumber();//第几行
