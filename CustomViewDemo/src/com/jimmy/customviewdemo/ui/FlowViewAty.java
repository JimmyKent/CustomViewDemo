...
public class FlowViewAty extends Activity {
	...
	private String[] contents = new String[] {"很专业", "非常棒", "回答很及时", "很满意", "态度超级好", "回答一般", "骚扰", "回答不专业", "不满意",
			"回答时间长"};
	private int[] imgs =
			new int[] {R.drawable.f018, R.drawable.f019, R.drawable.f020, R.drawable.f018, R.drawable.f021};

	private FlowLayout mTextFlowLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTextFlowLayout = (FlowLayout) findViewById(R.id.flowlayout_text);
